...
//    public static final String PAYMENT_FILE_PATH = System.getProperty("filePath", DATA_FILES_PATH + "/sanity/pain_fixed.xml");
    public static final String PAYMENT_FILE_PATH = System.getProperty("filePath", DATA_FILES_PATH + "/sanity/pain.xml");
